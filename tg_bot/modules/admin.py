...
def promote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if user_member.status == 'administrator' or user_member.status == 'creator':
        message.reply_text("Hehe, This user Is Already a Admin, How Can I Promote Again?...")
        return ""
    ...
    message.reply_text("Yep the user is Now Promoted! Enjoy!")
    return "<b>{}:</b>" \
           "\n#PROMOTED" \
           "\n<b>Admin:</b> {}" \
...
def demote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if user_member.status == 'creator':
        message.reply_text("This Group Belongs to this User, so I Can't demote my Master 😐")
        return ""
    ...
    if user_id == bot.id:
        message.reply_text("I Will Not Demote Myself! Hehe😆.")
        return ""
